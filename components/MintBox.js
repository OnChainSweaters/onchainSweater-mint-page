    ...
    <div className="relative pt-6 pb-16 sm:pb-24">
      <div className="mint-section">
        <div className="mint-box">
          <div className="mint-box-top"></div>
          ...
          <div className="mint-box-content">
            ...
            <div className="mint-box-form">
              <input className="mint-box-input" type="number" onChange={handleChange} value={mintCount} max="10" min="1"/> 
              <button className="mint-button">Mint</button>
            </div>
            
          </div>
          <div className="mint-box-bottom"></div>
        </div>
      </div>
    </div>
  );
